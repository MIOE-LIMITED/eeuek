// Tek seferlik veri düzeltmesi (2. parti): tek ürünlük/jenerik "marka"
// etiketleri — kumanda, drenaj pompası, temizlik spreyi, yedek parça vb. —
// "Muhtelif Markalar" altında toplanır. Bunlar gerçek üretici kataloğu değil,
// yedek-parca kategorisindeki tekil aksesuarlardır.
// Yalnızca bn/b değişir; ürün slug'ları (s) ve URL'ler aynı kalır.
//
// Kullanım:
//   node scripts/reassign-junk-brands-2.mjs --dry
//   node scripts/reassign-junk-brands-2.mjs
...
const JUNK = new Set([
  'Klima', 'Tcj-2Gsxz-3', 'Universal', 'Split', 'Seikon', 'Salon', 'Motip',
  'Mini', 'KT-N828', 'Green', 'Gree', 'Eros', 'Epoca', 'Baykan', 'Artiko', 'Alarko',
]);
